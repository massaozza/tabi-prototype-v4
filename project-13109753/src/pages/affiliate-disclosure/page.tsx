      ...
      <section className="bg-background-900 pt-24 md:pt-28 pb-16 md:pb-20 px-6 md:px-10">
        <div className="max-w-[860px] mx-auto">
          <nav className="flex items-center gap-2 text-white/50 text-xs mb-6" aria-label={t('auto_c766e66518', "Breadcrumb")}>
            ...
            <span className="text-white/30">/</span>
            <span className="text-white">{t('auto_8f415e7989', "Affiliate Disclosure")}</span>
          </nav>
          ...
          <h1 className="font-heading font-bold text-3xl md:text-5xl lg:text-6xl text-white mt-3 mb-3 leading-tight">
            {t('auto_8f415e7989', "Affiliate Disclosure")}
          </h1>
        ...
        <div className="max-w-[860px] mx-auto">
          ...
          <div className="space-y-12">
            <section id="summary">
              <div className="rounded-r-lg p-6 md:p-8" style={{ backgroundColor: '#FFF8E1', borderLeft: '4px solid #F5A623' }}>
                <p className="text-foreground-800 text-base md:text-lg leading-relaxed">
                  {t('auto_f8c1664a6d', "Some links on this site are affiliate links. If you click them and make a purchase, we may earn a small commission — at no extra cost to you. This is how we keep TABI free and independent.")}
                </p>
              </div>
            </section>

            <section id="commitment">
              <h2 className="font-heading font-bold text-xl md:text-2xl text-foreground-900 mb-4">{t('auto_f19af4818d', "1. Our Commitment to Transparency")}</h2>
              <p className="text-foreground-600 leading-relaxed">
                {t('auto_0482ab1bae', "TABI participates in affiliate marketing programs to help keep our content free for all readers. We believe in complete transparency about how we earn revenue. Our affiliate relationships comply with the United States Federal Trade Commission guidelines (16 CFR Part 255) concerning the use of endorsements and testimonials in advertising.")}
              </p>
            </section>
            ...
            <section id="ftc">
              <div className="border-2 border-background-200 rounded-lg p-6 md:p-8 bg-background-100">
                <p className="text-foreground-700 leading-relaxed font-medium">
                  {t('auto_40058a07e3', "TABI participates in affiliate marketing programs. When you click links on our site and make a qualifying purchase, we may receive a commission. This does not affect the price you pay. Our recommendations are based on genuine belief in the quality and value of the products and services we feature.")}
                </p>
              </div>
            </section>

            <section id="what-are">
              <h2 className="font-heading font-bold text-xl md:text-2xl text-foreground-900 mb-4">{t('auto_25afc793e0', "3. What Are Affiliate Links?")}</h2>
              <p className="text-foreground-600 leading-relaxed">
                {t('auto_ab04c623b2', "Affiliate links contain a special tracking code that lets our partner companies know you arrived from TABI. If you make a purchase, the company pays us a small commission from their marketing budget. This does not increase the price you pay — the commission comes from the company, not from you. Think of it as a referral fee for helping you discover something valuable for your Japan trip.")}
              </p>
            </section>

            <section id="partners">
              <h2 className="font-heading font-bold text-xl md:text-2xl text-foreground-900 mb-4">{t('auto_cfd385bff0', "4. Our Affiliate Partners")}</h2>
              <p className="text-foreground-600 leading-relaxed mb-6">
                {t('auto_9f2b8463cf', "We carefully select partners whose products and services we genuinely believe enhance the Japan travel experience. Here are the companies we currently work with:")}
              </p>
            ...
            <section id="editorial">
              <h2 className="font-heading font-bold text-xl md:text-2xl text-foreground-900 mb-4">{t('auto_4500dccb09', "5. Our Editorial Independence")}</h2>
              <p className="text-foreground-600 leading-relaxed mb-4">
                {t('auto_166927ec48', "We recommend products and services based on:")}
              </p>
              <ul className="space-y-3 mb-4">
                {[
                  t('auto_1b20ac35d1', "Personal experience and first-hand research by our team"),
                  t('auto_4f722de6b1', "Verified information from local sources and community feedback"),
                  t('auto_3ab2019c6d', "Honest assessment of value, quality, and relevance for travelers"),
                  t('auto_aa6fb708e1', "Reader feedback and real-world traveler experiences"),
                ].map((item) => (
              ...
              <p className="text-foreground-800 font-semibold">
                {t('auto_a72a5535d4', "We will NOT recommend something solely because it pays a higher commission. Our trust with readers is worth more than any affiliate payout.")}
              </p>
            </section>

            <section id="sponsored">
              <h2 className="font-heading font-bold text-xl md:text-2xl text-foreground-900 mb-4">{t('auto_b4023ed803', "6. Sponsored Content")}</h2>
              <p className="text-foreground-600 leading-relaxed">
                {t('auto_c699fd9388', "On rare occasions, TABI may publish sponsored content or paid partnerships. When we do, it will be clearly labeled as")}{' '}<strong className="text-foreground-800">{t('auto_fbb235d576', "\"Sponsored\"")}</strong> or <strong className="text-foreground-800">{t('auto_ab1d4fb51a', "\"Paid Partnership\"")}</strong>{' '}{t('auto_61feccaf71', "at the top of the content. Sponsored content is created with the same editorial standards as our regular content, and we only work with partners whose values align with our mission of authentic, meaningful travel experiences in Japan.")}
              </p>
            </section>

            <section id="contact">
              <h2 className="font-heading font-bold text-xl md:text-2xl text-foreground-900 mb-4">{t('auto_6cbd1b5046', "7. Contact")}</h2>
              <p className="text-foreground-600 leading-relaxed">
                {t('auto_2b98cfa412', "Questions about our affiliate relationships or editorial policies? Reach out at")}{' '}
                <a href="mailto:hello@tabi47.com" className="text-primary-500 hover:text-primary-600 underline cursor-pointer">
                  {t('auto_5da59dd5ed', "hello@tabi47.com")}
                </a>
              </p>
            </section>
          </div>
