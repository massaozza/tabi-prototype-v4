      ...
      <section className="bg-background-900 pt-24 md:pt-28 pb-16 md:pb-20 px-6 md:px-10">
        <div className="max-w-[860px] mx-auto">
          <nav className="flex items-center gap-2 text-white/50 text-xs mb-6" aria-label={t('auto_c766e66518', "Breadcrumb")}>
            ...
            <span className="text-white/30">/</span>
            <span className="text-white">{t('auto_4c4a2e80cc', "Disclaimer")}</span>
          </nav>
      ...
      <section className="px-6 md:px-10 py-12 md:py-16">
        <div className="max-w-[860px] mx-auto">
          ...
          <div className="space-y-12">
            <section id="summary">
              <div className="rounded-r-lg p-6 md:p-8" style={{ backgroundColor: '#F5F5F5', borderLeft: '4px solid #888888' }}>
                <p className="text-foreground-700 text-base md:text-lg leading-relaxed">
                  {t('auto_e7b7b7375f', "The information on TABI is provided for general informational purposes only. While we strive for accuracy, travel conditions change, and we encourage you to verify critical details independently.")}
                </p>
              </div>
            </section>

            <section id="general">
              <h2 className="font-heading font-bold text-xl md:text-2xl text-foreground-900 mb-4">{t('auto_feb342f9e1', "1. General Information")}</h2>
              <p className="text-foreground-600 leading-relaxed">
                {t('auto_e6b45259d6', "All content published on tabi47.com is for general informational and entertainment purposes only. We make every effort to ensure our guides, recommendations, and travel information are accurate and up to date, but we make no warranties of any kind — express or implied — about the completeness, accuracy, reliability, suitability, or availability of the information, products, services, or related graphics on this website.")}
              </p>
            </section>

            <section id="no-advice">
              <h2 className="font-heading font-bold text-xl md:text-2xl text-foreground-900 mb-4">{t('auto_9dad942c2e', "2. No Professional Advice")}</h2>
              <p className="text-foreground-600 leading-relaxed">
                {t('auto_e028020494', "The content on TABI does not constitute professional travel, legal, financial, medical, or safety advice. Travel decisions involve risks, and what worked for one traveler may not be suitable for another. Always consult official government sources, licensed professionals, and current local authorities for matters concerning:")}
              </p>
              <ul className="space-y-2 mt-4 pl-4">
                {[
                  t('auto_ab8ea140cb', "Visa requirements and entry procedures"),
                  t('auto_350d0b723b', "Health, vaccination, and travel insurance requirements"),
                  t('auto_1e3013f5a6', "Safety advisories and travel warnings"),
                  t('auto_9ac8bac1cf', "Financial matters including currency, taxes, and payment methods"),
                  t('auto_7fadee96a4', "Legal obligations in your destination country"),
                ].map((item) => (
            ...
            <section id="accuracy">
              <h2 className="font-heading font-bold text-xl md:text-2xl text-foreground-900 mb-4">{t('auto_8ddf543425', "3. Accuracy of Information")}</h2>
              <p className="text-foreground-600 leading-relaxed mb-4">
                {t('auto_276bc5aa96', "Japan is a dynamic country where things change. While we research thoroughly before publishing and update our content regularly, the following details can change without notice and may differ from what is presented on our site:")}
              </p>
              <ul className="space-y-3">
                {[
                  t('auto_059784c67e', "Opening hours and admission prices for temples, shrines, and attractions"),
                  t('auto_838de79ac2', "Transportation schedules, routes, fares, and pass validity"),
                  t('auto_61c02ccaef', "Visa policies and entry requirements for different nationalities"),
                  t('auto_fae13ac047', "Natural events such as cherry blossom timing, autumn foliage, and seasonal closures"),
                  t('auto_d8d059be5a', "Restaurant availability, menu items, and pricing"),
                ].map((item) => (
                  <li key={item} className="flex items-start gap-3 text-foreground-600 leading-relaxed">
              ...
              <p className="text-foreground-600 leading-relaxed mt-4">
                {t('auto_c0d92314c7', "We encourage you to verify critical information — especially transportation, accommodation, and visa details — through official sources before your trip.")}
              </p>
            </section>

            <section id="external">
              <h2 className="font-heading font-bold text-xl md:text-2xl text-foreground-900 mb-4">{t('auto_02ecfaa5f5', "4. External Links")}</h2>
              <p className="text-foreground-600 leading-relaxed">
                {t('auto_ed478da881', "TABI contains links to external websites that are not operated or controlled by us. We have no control over the content, privacy policies, or practices of any third-party websites and assume no responsibility for them. The inclusion of any link does not imply endorsement. We recommend reviewing the privacy policies and terms of any external site you visit.")}
              </p>
            </section>

            <section id="liability">
              <h2 className="font-heading font-bold text-xl md:text-2xl text-foreground-900 mb-4">{t('auto_f2d23db3d0', "5. Limitation of Liability")}</h2>
              <p className="text-foreground-600 leading-relaxed">
                {t('auto_47fd30136e', "To the fullest extent permitted by applicable law, TABI and its authors, contributors, and operators shall not be liable for any direct, indirect, incidental, consequential, or punitive damages arising from your use of, or reliance on, the information provided on this website. This includes, but is not limited to, financial losses, travel disruptions, injuries, or other damages resulting from inaccuracies, omissions, or outdated information. Your use of this website and reliance on any information is solely at your own risk.")}
              </p>
            </section>

            <section id="contact">
              <h2 className="font-heading font-bold text-xl md:text-2xl text-foreground-900 mb-4">{t('auto_999b2528c7', "6. Contact")}</h2>
              <p className="text-foreground-600 leading-relaxed">
                {t('auto_eafc04558f', "If you notice inaccurate information or have questions about this disclaimer, please contact us at")}{' '}
