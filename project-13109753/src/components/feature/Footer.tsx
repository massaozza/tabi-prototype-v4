        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          <div className="lg:col-span-2">
            ...
            <div className="bg-background-800/50 rounded-xl p-5 max-w-md">
              <h4 className="font-heading font-semibold text-sm mb-3">{t('auto_6f517e6703', "Get our free Japan travel guide")}</h4>
              <form className="flex flex-col sm:flex-row gap-2" data-readdy-form="" action="https://readdy.ai/api/form/d8khvl7jf7p243ot2mmg" method="POST" onSubmit={async (e) => {
                ...
                if (btn) { btn.textContent = t('auto_c338c191ab', "Sending..."); btn.disabled = true; }
                try {
                  ...
                  if (btn) btn.textContent = t('auto_b55b8bc368', "Subscribed!");
                } catch {
                ...
                <input
                  type="email"
                  name="email"
                  placeholder={t('auto_e1b1790da9', "Your email address")}
